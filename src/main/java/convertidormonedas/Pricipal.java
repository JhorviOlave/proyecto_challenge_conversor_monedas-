...
public class Pricipal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("""
                ...
                \t\t\t\t\t\t\t────────────╚══╝
                """);
        System.out.println("\n\t\tCuentas con 161 referencias de divisas de distintos paises, para comparar valor. ");
        System.out.println("****************************************************************************************************");
        do {            
            System.out.println("\n\t\tMenú de opciones:");
            ...
            switch (opcion) {
                case 1:
                 ...
                 case 2:
                        ...
                        System.out.print("Ingresa codigo de tu moneda local:..  ");
                        String codigoDe = sc.next();
                        System.out.print("Ingresa codigo de modena a la que quieres convertir :..  ");
